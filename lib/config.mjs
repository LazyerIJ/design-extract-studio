...
export function createConfig(overrides = {}) {
  ...
  return {
    ...
    // Layout extraction capability (additive). The server can run it, but each
    // job is opt-in — options.layout must be true. Set ENABLE_LAYOUT_EXTRACTION=0
    // to disable the capability entirely.
